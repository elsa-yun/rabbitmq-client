...
/**
 * @author longhaisheng message base config
 */
public class MqP2pConfig {
	...
	/** Message publish confirm */
	private boolean publishConfirm = true;
	...
	public boolean isPublishConfirm() {
		return publishConfirm;
	}

	public void setPublishConfirm(boolean publishConfirm) {
